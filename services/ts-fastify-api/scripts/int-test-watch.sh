...
# --watch ./node_modules/**/@s2lsoftener/*/src/**/* -e ts: deeply watch for changes in this package's local dependencies
...
pnpm exec nodemon -I -d 1 --legacy-watch --watch "./node_modules/**/@s2lsoftener/*/src/**/*" -e ts --exec "$TSC && $JEST_WATCH"